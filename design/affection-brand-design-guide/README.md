...
**Read `affection-brand-design-guide/project/Landing Page.dc.html` in full.**
The user had this file open when they triggered the handoff, so it's almost
certainly the primary design they want built. Read it top to bottom — don't
skim. Then **follow its imports**: open every file it pulls in (shared
components, CSS, scripts) so you understand how the pieces fit together before
...
- `affection-brand-design-guide/README.md` — this file
- `affection-brand-design-guide/project/` — the `Affection brand design guide`
